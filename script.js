var text="",amount,date;
			...
			function Fortuner()
			{
				...
				localStorage.setItem("amount",450);
				alert("his Forklift  will be booked for 450 EURO/-");
			}
			function RE350()
			{
				localStorage.setItem("text","Royal Enfield 350");
				localStorage.setItem("amount",50);
				alert("This Forklift  will be booked for 50 EURO-");
			}
			function RC390()
			{
				localStorage.setItem("text","KTM RC 390");
				localStorage.setItem("amount",45);
				alert("This Forklift  will be booked for 45 EURO-");
			}
			function Duke390()
			{
				localStorage.setItem("text","KTM Duke 390");
				localStorage.setItem("amount",60);
				alert("This Forklift  will be booked for 60 EURO-");
			}
			function Ninja300()
			{
				localStorage.setItem("text","Kawasaki Ninja 300");
				localStorage.setItem("amount",70);
				alert("This Forklift  will be booked for 70 EURO-");
			}
			function HD883()
			{
